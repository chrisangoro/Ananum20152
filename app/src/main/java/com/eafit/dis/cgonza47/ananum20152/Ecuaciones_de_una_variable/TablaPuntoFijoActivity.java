...
public class TablaPuntoFijoActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabla_punto_fijo);

        Intent intent = getIntent();
        funcion = intent.getStringExtra("funcion");
        metodo = (metodos) intent.getSerializableExtra("metodo");

        tl = (TableLayout) findViewById(R.id.Table_pf);
        ...
        for (int i = 0; i < metodo.getIter_pf().size(); i++) {
            ...
            iter.setText(String.valueOf(metodo.getIter_pf().get(i)));
            iter.setTextColor(Color.BLACK);
            iter.setPadding(10, 10, 10, 10);
            tr_head.addView(iter);
            ...
            vi = new TextView(this);
            vi.setId(i + 30000001);
            vi.setText(String.valueOf(metodo.getVi_pf().get(i)));
            vi.setTextColor(Color.BLACK);
            vi.setPadding(10, 10, 10, 10);
            tr_head.addView(vi);
            ...
            gx = new TextView(this);
            gx.setId(i + 40000001);
            gx.setText(formatter.format(metodo.getGx_pf().get(i)));
            gx.setTextColor(Color.BLACK);
            gx.setPadding(10, 10, 10, 10);
            tr_head.addView(gx);
            ...
            fx = new TextView(this);
            fx.setId(i + 50000001);
            fx.setText(formatter.format(metodo.getFx_pf().get(i)));
            fx.setTextColor(Color.BLACK);
            fx.setPadding(10, 10, 10, 10);
            tr_head.addView(fx);
            ...
            error.setText(formatter.format(metodo.getError_pf().get(i)));
            error.setTextColor(Color.BLACK);
            error.setPadding(10, 10, 10, 10);
            tr_head.addView(error);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tabla_punto_fijo, menu);
        return true;
    }
